          ...
          <tr>
            ...
            <td>
              <form action="course_add.php" method="post" onsubmit="confirmEdit(event, '<?php echo $course_name ?> Course');">
                <input type="hidden" name="edit_name" value="<?php echo $course_name ?>">
                <input type="hidden" name="edit_credit" value="<?php echo $course_credits ?>">
                <input type="hidden" name="edit_description" value="<?php echo $course_description ?>">
