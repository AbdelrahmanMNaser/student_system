...
<head>
    ...
    <title>Enroll Course | <?php echo $_SESSION["current_semester"] ?></title>
    ...
    <section class="mx-auto crs enroll min-vh-100 text-center py-5 px-3" id="courses">
        ...
        <form action="" method="post" id="courseForm">
            ...
            <select class="form-select w-15 mx-auto mb-4" name="course" id="courseSelect">
                ...
                $current_semester_id = $_SESSION['current_semester_id'];
                ...
                $retrieve = "SELECT 
                            ...
                            WHERE 
                                ...
                                AND teaching.semester_id = $current_semester_id
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    if ($result_pre->num_rows > 0) {
                        ...
                        // The course has prerequisites, check if the student has passed them all
                        $all_passed = true;
